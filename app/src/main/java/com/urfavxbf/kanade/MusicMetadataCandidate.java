...
public class MusicMetadataCandidate {
    ...
    public int getMusicBrainzScore() {
        return musicBrainzScore;
    }

    public void setMusicBrainzScore(
            int musicBrainzScore) {

        this.musicBrainzScore =
                musicBrainzScore;
    }
    ...
    public String getSafeAlbum() {

        return isEmpty(album)
                ? "Unknown Album"
                : album;
    }
